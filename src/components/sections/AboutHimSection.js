      ...
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2">
          <p className="text-lg text-gray-700 mb-6">
            Omar is a software engineer with a passion for cooking and hiking. Born and raised in Seattle, he loves the outdoors and spends his weekends exploring the mountains with his dog, Max.
          </p>
          <p className="text-lg text-gray-700 mb-6">
            He met Winnie during a charity marathon three years ago, and it was love at first sight. Omar proposed during a sunset hike at Mount Rainier, their favorite spot.
          </p>
